...
func (pq *PictureQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (pq *PictureQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (pq *PictureQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (pq *PictureQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (pq *PictureQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (pq *PictureQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := pq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (pq *PictureQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(picture.Table, picture.Columns, sqlgraph.NewFieldSpec(picture.FieldID, field.TypeUUID))
	_spec.From = pq.sql
